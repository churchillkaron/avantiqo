      ...
      <div className="relative z-10">
        ...
        <div className="mb-10 flex items-end justify-between">
          ...
          <div className="hidden xl:flex items-center gap-4">
            ...
            <div className="rounded-[28px] border border-white/[0.05] bg-white/[0.025] px-8 py-5 backdrop-blur-3xl">
        ...
        <div className="grid gap-6 xl:grid-cols-4">
          ...
          {[
            ...
            <div
              key={item.label}
              className="relative overflow-hidden rounded-[34px] border border-white/[0.05] bg-white/[0.025] p-8 backdrop-blur-3xl"
            >
        ...
        <div className="mt-6 grid gap-6 xl:grid-cols-3">
          ...
          <div className="xl:col-span-2 space-y-6">
            ...
            {/* LIVE OPERATIONS */}
            <div className="relative overflow-hidden rounded-[38px] border border-white/[0.05] bg-white/[0.025] p-6 md:p-10 backdrop-blur-3xl">
              ...
              <div className="relative z-10">
                ...
                <div className="mb-8 flex items-center justify-between">
                  ...
                  <div className="rounded-full border border-white/[0.05] bg-white/[0.025] px-5 py-2 text-sm text-white/50">
                    LIVE
                  </div>
                ...
                <div className="grid gap-5 md:grid-cols-3">
                  ...
                  {[
                    ...
                    <div
                      key={item}
                      className="rounded-[26px] border border-white/[0.05] bg-black/30 p-6"
                    >
              ...
              <div className="relative z-10">
                ...
                <div className="mt-10 grid gap-5">
                  ...
                  {[
                    ...
                    <div
                      key={item}
                      className="rounded-[24px] border border-white/[0.05] bg-black/30 p-6 text-white/50"
                    >
                      {item}
                    </div>
                  ))}
          ...
          <div className="space-y-6">
            ...
            {/* ACTIVITY */}
            <div className="relative overflow-hidden rounded-[38px] border border-white/[0.05] bg-white/[0.025] p-8 backdrop-blur-3xl">
              ...
              <div className="relative z-10">
                ...
                <div className="mt-8 space-y-4">
                  ...
                  {[
                    ...
                    <div
                      key={item}
                      className="rounded-[22px] border border-white/[0.05] bg-black/30 p-5 text-white/50"
                    >
                      {item}
                    </div>
                  ))}
              ...
              <div className="relative z-10">
                ...
                <div className="mt-8 space-y-4">
                  ...
                  {[
                    ...
                    <div
                      key={item}
                      className="flex items-center justify-between rounded-[22px] border border-white/[0.05] bg-black/30 px-5 py-4"
                    >
