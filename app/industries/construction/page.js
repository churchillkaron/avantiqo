...
import { constructionTranslations } from "@/lib/i18n/pages/construction";
...
export default function ConstructionPage() {
  ...
  const t =
    constructionTranslations[locale] ||
    constructionTranslations.en;
        ...
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-2">
          ...
          {runtimeCards.map((card, index) => (
            ...
            >
              ...
              <Image
                src={card.image || "/images/construction-owner-visibility.png"}
                alt={card.title}
                width={1200}
                height={700}
                quality={75}
