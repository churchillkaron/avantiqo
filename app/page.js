...
const capabilityGroups = [
  {
    title: "Operate",
    text: "Finance, operations, supply chain, people, projects, documents and compliance connected through one operating model.",
    items: ["Finance", "Operations", "Supply Chain", "People", "Projects", "Compliance"],
  },
  {
    title: "Understand",
    text: "Live analytics, forecasting, risk signals and executive intelligence that turn activity into clear decisions.",
    items: ["Analytics", "Forecasting", "Risk", "Business Health", "Planning", "Executive Intelligence"],
  },
  {
    title: "Create",
    text: "Campaigns, advertising, websites, presentations, film, imagery and brand systems from one autonomous creative studio.",
    items: ["Advertising", "Creative Studio", "Websites", "Video", "Brand Systems", "Campaigns"],
  },
  {
    title: "Automate",
    text: "Synthetic intelligence coordinates workflows, approvals, resources, services and outcomes across the whole company.",
    ...
    <div className="relative mx-auto aspect-square w-full max-w-[640px]">
      ...
      <div className="absolute inset-[36%] flex items-center justify-center rounded-full border border-[#F0C978]/50 bg-[radial-gradient(circle_at_35%_30%,rgba(214,166,106,.25),rgba(6,6,6,.96)_62%)] shadow-[0_0_100px_rgba(214,166,106,.14)]">
        <div className="text-center">
          <img src="/avantiqo-logo.png" alt="Avantiqo" className="mx-auto h-14 w-auto object-contain" />
          <div className="mt-3 text-[7px] uppercase tracking-[0.38em] text-white/45">Synthetic Core</div>
        </div>
      </div>
      ...
      <section className="relative z-10 mx-auto grid min-h-screen w-full max-w-[1500px] items-center gap-12 px-6 py-14 sm:px-10 lg:grid-cols-[0.94fr_1.06fr] lg:px-14 lg:py-20">
        <div className="max-w-[700px]">
          <div className="flex items-center gap-4">
            <img src="/avantiqo-logo.png" alt="Avantiqo" className="h-14 w-auto object-contain" />
            <div>
              <div className="text-[16px] font-medium uppercase tracking-[0.34em] text-[#F3E8D2]">Avantiqo</div>
              <div className="mt-1 text-[8px] uppercase tracking-[0.28em] text-[#D6A66A]/62">Synthetic Intelligence Operating System</div>
            </div>
          </div>
          ...
          <h1 className="mt-7 font-serif text-[clamp(3.6rem,7.8vw,7.8rem)] font-normal leading-[0.86] tracking-[-0.055em] text-[#F3EFE8]">
            Synthetic
            <br />
            <span className="bg-gradient-to-r from-[#A96D2B] via-[#F1D28D] to-[#A47886] bg-clip-text text-transparent">Intelligence</span>
            <br />
            Operating System
          </h1>
          ...
          <div className="mt-9 flex flex-wrap gap-3">
            {["Unify", "Understand", "Create", "Operate", "Scale"].map((item) => (
              <span key={item} className="rounded-full border border-white/[0.08] bg-white/[0.025] px-4 py-2 text-[9px] uppercase tracking-[0.22em] text-white/45">{item}</span>
            ))}
          </div>
      ...
      <section className="relative z-10 mx-auto w-full max-w-[1500px] px-6 py-24 sm:px-10 lg:px-14 lg:py-32">
        ...
        <div className="mt-14 grid gap-4 md:grid-cols-2">
          {capabilityGroups.map((group, index) => (
            <article key={group.title} className="group relative overflow-hidden rounded-[28px] border border-white/[0.075] bg-[linear-gradient(145deg,rgba(18,18,18,.94),rgba(7,7,7,.96))] p-7 sm:p-9">
              ...
              <div className="relative">
                ...
                <p className="mt-4 max-w-xl text-[13px] leading-6 text-white/40">{group.text}</p>
                <div className="mt-8 flex flex-wrap gap-2">
                  {group.items.map((item) => (
                    <span key={item} className="rounded-full border border-white/[0.075] bg-black/30 px-3 py-2 text-[8px] uppercase tracking-[0.19em] text-white/38">{item}</span>
                  ))}
                </div>
              </div>
            </article>
      ...
      <section className="relative z-10 border-t border-white/[0.06] px-6 py-20 sm:px-10 lg:px-14 lg:py-28">
        <div className="mx-auto w-full max-w-[1500px] text-center">
          ...
          <h2 className="mx-auto mt-5 max-w-5xl font-serif text-[clamp(2.8rem,6vw,6rem)] leading-[0.95] tracking-[-0.04em] text-[#F1ECE3]">
            ...
            <span className="block bg-gradient-to-r from-[#D8A95D] to-[#9B7884] bg-clip-text text-transparent">It will operate through it.</span>
          </h2>
        </div>
      </section>
