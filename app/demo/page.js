  ...
  return (
    <main className="min-h-screen bg-[#02030A] text-white">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="max-w-5xl">
            ...
            <div className="mt-14 flex flex-col gap-4 sm:flex-row">
              ...
              <button className="rounded-full border border-white/[0.05] bg-white/[0.025] px-10 py-5 text-lg font-extralight text-white backdrop-blur-3xl transition duration-300 hover:bg-white/[0.06]">
                Contact Sales
              </button>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-6 md:gap-8 lg:grid-cols-2">
            ...
            {[
              ...
              <div
                key={item.title}
                className="group relative overflow-hidden rounded-[34px] border border-white/[0.05] bg-white/[0.025] backdrop-blur-3xl"
              >
      ...
      <section className="relative overflow-hidden px-6 pb-24 md:pb-36">
        ...
        <div className="mx-auto max-w-7xl overflow-hidden rounded-[40px] border border-white/[0.05] bg-white/[0.025] p-6 md:p-10 backdrop-blur-3xl md:p-16">
          ...
          <div className="grid gap-6 md:grid-cols-5">
            ...
            {[
              ...
              <div
                key={step}
                className="relative overflow-hidden rounded-[28px] border border-white/[0.05] bg-[#02030A]/80 p-8"
              >
